    ...
    if($uname=="")
    {
            ...
            if($no > 0)
            {
             ...
             mysqli_query($con, $sql);
               echo "<script> alert('Registration successfull'); window.location.href='healthlogin.php';</script>";
             }
         }
         else
            echo "<script> alert('please enter password correctly'); window.location.href='healthregister.php';</script>";
}
else
