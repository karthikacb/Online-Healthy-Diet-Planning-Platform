<?php      
    ...
    $des = $_POST['des'];
        ...
        `cid`='$cid',`cname`='$cname',`des`='$des' where cid='$cid'");
                                ...
                                <div class="block-content">
                                    ...
                                    <form method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="text" class="form-control" name="cname" id="cname" onfocusout="f1()" value="<?php echo $cname ?>" required onChange="Valr();">
                                            </div>
                                        </div>
