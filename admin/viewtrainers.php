        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> View Trainer </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> View Trainer</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      ...
                      <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search Trainers" title="Type in a name">
                    </div>
...
?>
   ...
   <td><?php echo $r['gender'];?></td>
	 ...
	 <td><img src="../uploads/<?php echo $r['certificate'];?>" width="100" height="100"></td>
	 
     <td><a style="color:#F63" href="deletetrainers.php?id=<?php echo $r['loginid'];?>"><b>Delete</a></td></tr>
                      <?php
}
?>
                        </tbody>
