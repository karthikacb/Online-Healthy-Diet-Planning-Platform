			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 col-xs-12">
                    ...
                    <?php
								...
								$sql="select * from plandetails where logid=$id and status='Updated' & 'Reported'";
								$res1=mysqli_query($con,$sql);?>
                        <thead>
                            <tr>
                                <th style="width:500px;">Medical Details</th>
								<th style="width:500px;">Dietitian Selected</th>
								<th style="width:200px;">Payment Charge</th>
                        ...
                        <?php
								...
								$did=$r['detailid'];
								$dietid=$r['dname'];
								$sql1="select * from postsolution where detailid=$did";
								$res11=mysqli_query($con,$sql1);
								$j=mysqli_fetch_array($res11);
								$sql2="select * from dietitian where dietionid=$dietid";
								$res12=mysqli_query($con,$sql2);
								$k=mysqli_fetch_array($res12);
								?>

								<tr>
								<td><b>Date:</b> <?php echo $r['date'];?></br>
								<b>Age:</b> <?php echo $r['age'];?></br>
		                        <b>Height:</b> <?php echo $r['height'];?></br>
                                <b>Weight:</b> <?php echo $r['weight'];?></br>
                                <b>Target Weight:</b> <?php echo $r['targetweight'];?></br>
                                <b>Sugar count:</b> <?php echo $r['sugar'];?></br>
                                <b>Blood-Pressure count:</b> <?php echo $r['bp'];?></br>
                                <b>Cholesterol count:</b> <?php echo $r['cho'];?></br>
		                        <b>Current Food Habits:</b> <?php echo $r['habits'];?></br>
		                        <b>Diet Required For:</b> <?php echo $r['dietrequired'];?></br>
		                        <b>Disease:</b> <?php echo $r['disease'];?></br>
		                        <b>Description:</b> <?php echo $r['discription'];?></br>
							    </td>
								<td><b>Dietitian Selected:</b> <?php echo $k['name'];?></td>
                                <td><b>Payment Charge:</b> <?php echo $r['charge'];?></td>
								<td><button type="submit" class="btn btn-primary"><a href="paymentprocess.php" style="color:white;">Pay</a></button></td>
