			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 col-xs-12">
					...
					<?php
								...
								$sql="select * from postsolution where loginid=$id and status='Updated'";
								$res1=mysqli_query($con,$sql);?>
                        <thead>
                            <tr>
                                <th style="width:300px;">Diet chart</th>
                                <th style="width:300px;">Follow(day/week/month)</th>
                        ...
                        <?php
								...
								{
								$did=$r['postid'];
								$sql1="select * from solutionbackup where postid='$did'";
								$res11=mysqli_query($con,$sql1);
								while($j=mysqli_fetch_array($res11))
								{
								?>
								
								<tr>
								<!-- <td><b>Date</b> <?php echo $j['updt'];?></td> -->
								<!-- <td><b>Date</b> <?php echo $r['date'];?></td> -->
		                        <!-- <b>Height:</b> <?php echo $j['height'];?></br> -->
								<td><embed src="../uploads/<?php echo $j['image'];?>" width="150" height="150"></td>
							   <td> <?php echo $j['dwm'];?></td>
								<!-- <b>Weight:</b> <?php echo $j['weight'];?></br>
                               <b>Sugar:</b> <?php echo $j['sugar'];?></br>
                               <b>Bloop Pressure:</b> <?php echo $j['bp'];?></br>
                               <b>Cholesterol:</b> <?php echo $j['cho'];?></br>
		                        <b>Current Food Habits:</b> <?php echo $j['habits'];?></br>
		                        <b>Diet Required For:</b> <?php echo $j['dietrequired'];?></br>
		                        <b>Disease:</b> <?php echo $j['disease'];?></br>
