...
$sql="select * from counselling WHERE status='active'";
...
{?>
        ...
        <td><img src="../uploads/<?php echo $r['file'];?>" width="100" height="100"></td></tr>
                      <?php
}
?></tbody>
                    </table>
