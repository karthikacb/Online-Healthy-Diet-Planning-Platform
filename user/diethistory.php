			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 col-xs-12">
                    ...
                    <?php
								...
								$sql="select * from plandetails where logid=$id and status='Updated'";
								$res1=mysqli_query($con,$sql);?>
                        <thead>
                            <tr>
                                <th style="width:300px;">Date</th>
                                <th style="width:300px;">Medical Details</th>
                        ...
                        <?php
								...
								{
								$did=$r['detailid'];
								$sql1="select * from planbackup where detailid='$did'";
                               ...
                               <td><b>Weight:</b> <?php echo $j['weight'];?></br>
