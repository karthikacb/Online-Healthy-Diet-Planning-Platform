				...
				<div class="col-lg-12 col-sm-12 col-xs-12">
					...
					<thead>
                            <tr>
                                ...
                                <th style="width:500px;">Diet Plan By Dietitian</th>
                                <th style="width:500px;">Follow Diet Plan</th>
								  <!-- <th>Status</th> -->
                            </tr>
                        </thead>
                    <?php
								include '../connection.php';
								$sql="select * from plandetails where logid=$id and status='Posted'";
								$res1=mysqli_query($con,$sql);
								while($r=mysqli_fetch_array($res1))
								{
								$did=$r['detailid'];
								$sql1="select * from postsolution where detailid=$did and status='Posted'";
								$res11=mysqli_query($con,$sql1);
								$j=mysqli_fetch_array($res11);
								?>

								<tr>
								<!-- <td><b>Age:</b> <?php echo $r['age'];?></br>
                                ...
                                <td><embed src="../uploads/<?php echo $j['image'];?>" width="200" height="200"></td> 
								<td><b>Diet Plan:</b> <?php echo $j['dwm'];?></td>
