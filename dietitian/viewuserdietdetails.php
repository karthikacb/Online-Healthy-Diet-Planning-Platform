...
<body>
	...
	<div class="full-title">
		<div class="container">
			...
			<h1 class="mt-4 mb-3">Diet Plan Request
			</h1>
		</div>
	</div>
    ...
    <div class="container">
      ...
      <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Diet Plan Request</h4>
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                         <th class="text-center"> User Details</th>
								 <th class="text-center">User Id-Proof</th>
...
$sql="select * from plandetails  where status='Updated' and dname='$re'";
...
<input type="hidden" name="cid" value="<?php echo $cid;?>">
      ...
      <?php echo $r1['lname'];?><br/></br>
		...
		<td><img src="../uploads/<?php echo $r['idproof'];?>" width="150" height="100" /></td>
      ...
      <b>Cholesterol Count:</b> <?php echo $k['cho'];?></br></br>
		...
		<td><button type="submit" class="btn btn-primary"><a href="postsolution.php?det=<?php echo $id   ?>det=<?php echo $did   ?>" style="color:white;">Post Solution</a></button></td>
