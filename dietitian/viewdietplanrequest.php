...
$sql="select * from plandetails  where status='Reported' and dname='$re'";
...
<input type="hidden" name="cid" value="<?php echo $cid;?>">
      ...
      <b>Cholesterol Count:</b> <?php echo $k['cho'];?></br></br>
		...
		<td><button type="submit" class="btn btn-primary"><a href="bill.php?det=<?php echo $id   ?>detlta=<?php echo $did   ?>" style="color:white;">Add bill</a></button></td>
