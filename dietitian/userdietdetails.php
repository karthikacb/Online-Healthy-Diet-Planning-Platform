...
<input type="hidden" name="cid" value="<?php echo $cid;?>">
      ...
      <!-- <td><embed src="../uploads/<?php echo $q['image'];?>" width="200" height="200"></td> 
      <td><?php echo $q['dwm'];?></td> -->
		<td><button type="submit" class="btn btn-primary"><a href="updatedietplan.php?postid=<?php echo $q['postid'];?>did=<?php echo $q['detailid'];?>" style="color:white;">Update Diet Plan</a></button></td>
